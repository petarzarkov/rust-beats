...
pub fn get_mixing_preset(preset: MixingPreset) -> (
    f32, f32, f32, f32,  // Drum: vol, eq_l, eq_m, eq_h
    f32, f32, f32, f32,  // Bass: vol, eq_l, eq_m, eq_h
    f32, f32, f32, f32,  // Melody: vol, eq_l, eq_m, eq_h
    f32,                 // Pad: vol
) {
    match preset {
        MixingPreset::Clean => (
