...
use super::{Track, mixing_presets::MixingPreset};
...
pub fn build_tracks(
    ...
    let (
        drum_vol, drum_eq_l, drum_eq_m, drum_eq_h,
        bass_vol, bass_eq_l, bass_eq_m, bass_eq_h,
        melody_vol, melody_eq_l, melody_eq_m, melody_eq_h,
        _pad_vol_base,
